        ...
        while (true) {
            ...
            if (chances >= 1) {
                ...
                else if (randomNumber > playerGuess) // compare guess number and random number
                {
                    ...
                    System.out.println("Nope! The number is higher. Guess again.");// if random number is greater than
                                                                                   // guess number then print this
                                                                                   // message
                    chances--;
                    ...
                    System.out.println("Nope! The number is lower. Guess again.");// if random number is smaller than
                                                                                  // guess number then print this
                                                                                  // message
                    chances--;
